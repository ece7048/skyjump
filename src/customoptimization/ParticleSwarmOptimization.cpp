...
namespace SimTK
{
    Real ParticleSwarmOptimizer::optimize(Vector & results)
    {
        return Real();
    }
    Optimizer::OptimizerRep* ParticleSwarmOptimizer::clone() const
    {
        return new ParticleSwarmOptimizer(*this);
    }

    // Assume by the time this constructor is called, the number of parameters and constraints has been finalized
    ParticleSwarmOptimizer::ParticleSwarmOptimizer(const OptimizerSystem& sys)
        : OptimizerRep(sys)
    {
        ...
        //    if (n < 1)
        //    {
        //        const char* where = " ParticleSwarmOptimizer Initialization";
        ...
        //SimTK::Real ParticleSwarmOptimizer::optimize(Vector &results)
        //{
