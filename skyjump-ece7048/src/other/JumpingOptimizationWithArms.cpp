/* -------------------------------------------------------------------------- *
 *                  OpenSim:  JumpingOptimizationWithArms.cpp                 *
 * -------------------------------------------------------------------------- *
 ...
 *  is similar to JumpingOptimization.cpp, but it loads a model that has arms
 *  ("jumper10dof24musc_withArms.osim") with one degree of freedom for arm flexion
 *  at each shoulder joint. It also has 2 extra controllerParameters to control
 *  the shoulder joint torques, which were based on joint torques found by
 *  Otis, J.C., et al. (1990).
 *  
 */
